...
test.describe("Step 12", () => {
  ...
  test("should be able to add attributes and events to html components", async ({
    ...
    await page.goto(
      `file://${getTestDirectoryPath()}/version-in-video/${getParentDirectory()}/step9.html`
    );
  ...
  test("should be able to manage state in React class components", async ({
    ...
    await page.goto(
      `file://${getTestDirectoryPath()}/version-in-video/${getParentDirectory()}/step10.html`
    );
  ...
  test("should be able to manage state in React class components when the root component is a React class component and has multiple class components inside it", async ({
    ...
    await page.goto(
      `file://${getTestDirectoryPath()}/version-in-video/${getParentDirectory()}/step11.html`
    );
  ...
  test("should transpile JSX and support arrays as children", async ({
    ...
    await page.goto(
      `file://${getTestDirectoryPath()}/version-in-video/${getParentDirectory()}/step12.html`
    );
